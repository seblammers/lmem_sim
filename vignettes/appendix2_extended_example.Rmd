...
This section will simulate data and run a power analysis for a 2x2 design where the first factor is within subjects and within items and the second factor is within subjects and between items.
...
sim_data_2ww2wb <- function(
  ...
  beta_c     =  50, # main effect of category
